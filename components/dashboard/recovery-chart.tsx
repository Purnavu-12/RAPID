...
export function RecoveryChart({ trend }: { trend: TrendPoint[] | null }) {
  ...
  return (
    ...
    >
      <div className="px-6 py-4 border-b border-foreground/10 flex items-center justify-between">
        ...
        {trend ? (
          <span className="text-xs font-mono text-green-500">
            {trend.reduce((a, b) => a + b.recovered, 0)} recoveries
          </span>
        ) : (
      ...
      <div className="p-6">
        {trend === null ? (
          <div className="h-60 w-full bg-foreground/5 rounded animate-pulse" />
        ) : (
